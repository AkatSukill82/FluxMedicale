...
// Données de référence OMS pour courbes de croissance (simplifiées)
const WHO_PERCENTILES = {
  weight_boys: {
    p3: [[0, 2.5], [12, 7.8], [24, 10.5], [36, 12.5], [48, 14.5], [60, 16.5]],
    p50: [[0, 3.3], [12, 9.6], [24, 12.2], [36, 14.3], [48, 16.3], [60, 18.3]],
    p97: [[0, 4.3], [12, 11.8], [24, 14.5], [36, 17.0], [48, 19.5], [60, 22.0]]
  },
  weight_girls: {
    p3: [[0, 2.4], [12, 7.2], [24, 9.8], [36, 11.8], [48, 13.8], [60, 15.8]],
    p50: [[0, 3.2], [12, 8.9], [24, 11.5], [36, 13.5], [48, 15.8], [60, 17.8]],
    p97: [[0, 4.2], [12, 11.0], [24, 13.8], [36, 16.2], [48, 19.0], [60, 21.5]]
  },
  height_boys: {
    p3: [[0, 46], [12, 71], [24, 82], [36, 90], [48, 97], [60, 103]],
    p50: [[0, 50], [12, 76], [24, 87], [36, 96], [48, 103], [60, 110]],
    p97: [[0, 54], [12, 81], [24, 92], [36, 102], [48, 110], [60, 118]]
  },
  height_girls: {
    p3: [[0, 45], [12, 69], [24, 80], [36, 88], [48, 95], [60, 101]],
    p50: [[0, 49], [12, 74], [24, 86], [36, 95], [48, 102], [60, 109]],
    p97: [[0, 53], [12, 79], [24, 91], [36, 101], [48, 109], [60, 116]]
  }
};
