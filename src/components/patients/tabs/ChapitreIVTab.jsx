    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-xl font-bold">Chapitre IV</h2>
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1 cursor-pointer" onClick={() => setSelectedRequest(request)}>
                      ...
                      <div className="flex items-center gap-2 mb-2 flex-wrap">
                        ...
                        <span className="font-semibold">{request.medication_name || 'Médicament non spécifié'}</span>
                        ...
                        {request.renewal_of && (
                          <Badge variant="outline" className="text-xs">Renouvellement</Badge>
                        )}
                      </div>
                      ...
                      <div className="grid grid-cols-2 gap-x-4 gap-y-1 text-sm text-slate-600">
                        ...
                        {request.submitted_at && (
                          <div>
                            <span className="text-slate-400">Soumise:</span>{' '}
      ...
      <Alert className="bg-blue-50 border-blue-200">
        ...
        <AlertDescription className="text-blue-900 text-sm">
          ...
          En l'absence de réponse, l'accord est considéré comme tacite (silence vaut accord).
        </AlertDescription>
      </Alert>
